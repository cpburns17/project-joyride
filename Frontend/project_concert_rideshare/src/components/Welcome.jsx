...
return (
    <div className='welcome-page'>
        ...
        <p className='testimonials'>
            “I always drive to EZoo from Staten Island, and figured I’d check out JoyRide to see if there’s anyone on the way who would be willing to pitch in for gas money. I found 2 amazing humans who not only pitched in for gas, but they also bought me drinks! Talk about a win-win!” - Sarah, 22
        </p>
        <p className='testimonials'>
